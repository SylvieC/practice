      ...
      if(frame.num != 10){
       ...
       if (frame.num != 10){
          if ( (score_to_add + frame.turn1) == 10){
             alert('this is a spare');
             updatedFrameData.turn2 = score_to_add;
             updatedFrameData.category = 'spare';
           }else{
            alert('not spare');
            var answer = (score_to_add + frame.turn1 == 10); 
            alert(' score_to_add '+ score_to_add + ' frame.turn1 ' + frame.turn1 + ' ' + 'frame.num' + frame.num +' ' +   answer );
            updatedFrameData.turn2 = score_to_add;
          }
...
//if I get all the pins at turn 2 is it still considered a strike     
